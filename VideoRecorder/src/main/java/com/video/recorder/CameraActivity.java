 ...
 */
public class CameraActivity extends Activity implements View.OnClickListener, RecordedButton.ProgressListener {
//    private static final String TAG = CameraActivity.class.getSimpleName();
    public static final String OUT_FIle_KEY ="output";
    private int focus_area_size = 500;
    ...
    private RecordedButton mZoomProgressBtn;
...
//    public static void startRecordActivity(Activity activity, int requestCode) {
//        Intent intent = new Intent(activity, CameraActivity.class);
//        activity.startActivityForResult(intent, requestCode);
//    }
//
//    public static void startRecordActivity(Activity activity, int requestCode, String path) {
//        Intent intent = new Intent(activity, CameraActivity.class);
...
//    }
    ...
    protected void onDestroy() {
        ...
        if (mZoomProgressBtn != null) {
            mZoomProgressBtn.onDestroy();
        }
        mFocusAnimation = null;
        url_file = null;
        if (mCamera != null) {
            mCamera.release();
        }
        ...
        mediaRecorder = null;
        flashListener = null;
        switchCameraListener = null;
        mAutoFocusTakePictureCallback = null;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mZoomProgressBtn = (RecordedButton) findViewById(R.id.button_capture);
    ...
    private void initFocusView() {
        ...
        camera_preview.addView(mFocusAnimationView,
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    try {
                        ...
                        Log.i("CameraActivity", getString(R.string.fail_when_camera_try_autofocus, e.toString()));
                    }
                }
                return true;
            }
    ...
    private boolean prepareMediaRecorder() {
        try {
            ...
            if (getIntent().getStringExtra("path")==null|| getIntent().getStringExtra("path").isEmpty()){
                url_file = getExternalFilesDir(Environment.DIRECTORY_DCIM)+"/"+ System.currentTimeMillis()+ ".mp4";
            }else {
                url_file = getIntent().getStringExtra("path");
            }
    ...
    private void releaseCamera(String aaa) {
        if (mCamera != null) {
            mCamera.release();
            mCamera = null;
        }
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.img_back) {
            ...
            bundle.putString(OUT_FIle_KEY, url_file);
