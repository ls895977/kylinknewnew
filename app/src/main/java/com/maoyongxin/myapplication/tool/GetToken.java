...
import com.maoyongxin.myapplication.entity.UserRespone;
...
public class GetToken {
    public static String GetRongCloudToken(String username) {
        ...
        String App_Key = "x18ywvqfxn2bc"; //开发者平台分配的 App Key。
        String App_Secret = "PHofbfuzNnN";
        ...
        UserRespone userRespone = GsonUtil.json2Entity(res.toString(), UserRespone.class);
