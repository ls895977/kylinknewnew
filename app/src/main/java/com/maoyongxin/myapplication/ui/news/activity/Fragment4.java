...
public class Fragment4 extends Fragment {
    ...
    Unbinder unbinder;
    private List<fragment5Bean.ObjBean.NewsListBean> newsList;
    @Nullable
    @Override
    ...
    private void initview() {
        ...
        OkHttpUtils.post().url(Contant.MeUrl2 + "newscontroller/getNews")
            ...
            public void onResponse(String response, int id) {
                Gson gson = new Gson();
                fragment5Bean new4bean = gson.fromJson(response, fragment5Bean.class);
    ...
    public class aineirong extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(getContext()).inflate(R.layout.falist5, parent, false);
