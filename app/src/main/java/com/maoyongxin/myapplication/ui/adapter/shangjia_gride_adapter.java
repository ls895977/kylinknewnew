...
public class shangjia_gride_adapter extends BaseAdapter{
    ...
    public shangjia_gride_adapter(Context mContext, List<grideInfo> yellowPage_info) {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        final shangjia_gride_adapter.ViewHolder viewHolder ;

        view = LayoutInflater.from(mContext).inflate(R.layout.item_gride_layout, null);
        viewHolder = new shangjia_gride_adapter.ViewHolder();
