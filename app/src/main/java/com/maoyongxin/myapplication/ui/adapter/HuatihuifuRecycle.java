 ...
 */
public class HuatihuifuRecycle extends RecyclerView.Adapter<HuatihuifuRecycle.MyHolder> implements ShareDialogFragment.Listener {
    List<HuatiInfo> list;
    Context context;
    ...
    public HuatihuifuRecycle(List<HuatiInfo> list, Context context, LongClickListener listener) {
        this.list = list;
