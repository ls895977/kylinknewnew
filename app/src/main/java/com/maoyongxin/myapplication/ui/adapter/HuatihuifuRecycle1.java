 ...
 */
public class HuatihuifuRecycle1 extends RecyclerView.Adapter<HuatihuifuRecycle1.MyHolder> implements ShareDialogFragment.Listener {
    List<HuatiInfo> list;
    Context context;
    ...
    public HuatihuifuRecycle1(List<HuatiInfo> list, Context context, LongClickListener listener) {
        this.list = list;
    ...
    public void onBindViewHolder(final MyHolder myholder, int i) {
        ...
        holder.ll_response.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("holdercontent", list.get(position).getHuatiName());
                ...
                intent.putExtra("first_headimg", list.get(position).getfirst_headimg());
                intent.putExtra("parentRespId", list.get(position).getHuatiIp());
