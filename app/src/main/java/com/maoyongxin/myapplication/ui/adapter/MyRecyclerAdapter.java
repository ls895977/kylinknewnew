...
import com.maoyongxin.myapplication.entity.dynamicPLDZ;
...
public class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.MyHolder> {
    ...
    private List<dynamicPLDZ> pldzList;
    private String dynamicInfo="http://st.3dgogo.com/index/user_dynamic/get_user_dynamic_post_api.html";
    public MyRecyclerAdapter(List<MyDynamicListInfo.DynamicList> list, Context context, boolean fromSquare) {
        this.list = list;
    ...
    public void onBindViewHolder(final MyHolder holder, int i) {
        ...
        getUserInfo(list.get(i).getDynamic().getUserId() + "", holder);
    ...
    private void getUserInfo(String userId, final MyHolder holder) {
        ReqFindUserById.findUser(context, "adapter", userId, new EntityCallBack<LoginResponse>() {
            ...
            public void onSuccess(LoginResponse resp) {
                if (resp.is200()) {
                    ...
                    getDynamicZan(dynamicInfo,holder);
    ...
    private void getDynamicZan(final String api_url,final MyHolder holder){
            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        holder.NUMDZ=data.getInt("numDZ");

                        holder.numZan.setText(holder.NUMDZ);

                        holder.NUMPL=data.getInt("numPL");
                        ...
                        holder.numZan.setText("88");

                        holder.NUMPL=99;
                        holder.numPL.setText("99");
