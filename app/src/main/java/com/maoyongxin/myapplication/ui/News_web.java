...
public class News_web extends AppActivity implements ShareDialogFragment.Listener {
    ...
    protected int bindLayout() {
        ...
        return (R.layout.activity_show_web_ql);
    }
    ...
    protected void initEvent() {
        ...
        contactFwy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent=new Intent(getActivity(),fuwuhao_contact.class);
...
//其他细节操作
        ...
        try{
            JShareInterface.share(Wechat.Name, generateParams(), new PlatActionListener() {
                ...
                public void onComplete(Platform platform, int i, HashMap<String, Object> hashMap) {
                    Log.d("---", "onComplete:" + i);
                    backdatatoserver(getIntent().getStringExtra("communityId"),"2");
                }
    ...
    private void shareWeChatMoments() {
        ...
        backdatatoserver(getIntent().getStringExtra("communityId"),"3");
    }
    ...
    private void backdatatoserver(final String communityid,final  String type)
    {
        new Thread(new Runnable() {
            @Override
            public void run() {
