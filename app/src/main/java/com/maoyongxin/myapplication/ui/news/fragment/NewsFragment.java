package com.maoyongxin.myapplication.ui.news.fragment;
...
import com.maoyongxin.myapplication.ui.news.activity.NewsBaseActivity;
import com.maoyongxin.myapplication.ui.news.adapter.NewsAdapter;
import com.maoyongxin.myapplication.ui.news.data.DataManager;
import com.maoyongxin.myapplication.ui.news.data.NewsItem;
import com.maoyongxin.myapplication.ui.news.view.flipview.FlipLayoutManager;
import com.maoyongxin.myapplication.ui.news.view.flipview.FlipRefreshListener;
import com.maoyongxin.myapplication.ui.news.view.flipview.MySnap;
...
public class NewsFragment extends Fragment implements FlipRefreshListener.Listener, NewsAdapter.Listener {
    ...
    private NewsBaseActivity baseActivity;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof BaseActivity) {
            baseActivity = (NewsBaseActivity) context;
        }
    }
    ...
    private Action1<List<NewsItem>> onNew = new Action1<List<NewsItem>>() {
        @Override
        public void call(List<NewsItem> gankItemList) {
            mIsLoading = false;
            ...
            if (gankItemList.size() > 0) {
                ...
                if (!latest.equals(mLatest)) {
                    ...
                    mAdapter.clear();
                    if (mType != null) {
                        Iterator<NewsItem> itemIterator = gankItemList.listIterator();
    ...
    private Action1<List<NewsItem>> onMore = new Action1<List<NewsItem>>() {
        @Override
        public void call(List<NewsItem> gankItemList) {
            mIsLoading = false;
