...
public class ReqDealRequest extends Req {
    public static void dealRequest(Context context, String httpTag, String userId, String requestId,String requestState,
                                  final EntityCallBack<BaseResp> callBack) {
        request(context,getCommonReqBuilder(ApiMgr.DEAL_REQUEST, httpTag)
                .addBody("userId", userId)
                .addBody("requestId", requestId)
                .addBody("requestState", requestState)
