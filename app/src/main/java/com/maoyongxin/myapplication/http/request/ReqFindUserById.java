...
public class ReqFindUserById extends Req {
    public static void findUser(Context context, String httpTag, String userId,
                                  final EntityCallBack<LoginResponse> callBack) {
        request(context,getCommonReqBuilder(ApiMgr.GET_USERINFO_BYID, httpTag)
